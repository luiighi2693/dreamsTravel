	...
	<body>
				...
				<div class="bottom">
					...
					<!-- Social Icons -->
						<ul class="icons">
							...
							<li><a href="https://www.facebook.com/dreamstravelvirtual/?fref=ts" class="icon fa-facebook"><span class="label">Facebook</span></a></li>
		...
		<!-- Footer -->
			<div id="footer">
				...
				<!-- Copyright -->
					<ul class="copyright">
						<li>&copy; Untitled. All rights reserved.</li><li>Design: L. R.</li>
					</ul>
